...
from torch.distributions import Distribution, register_kl, kl_divergence, Normal
...
class PathDistribution(Distribution):
    """Base class for distributions of paths generated by an SDE  on a homogeneous space of the form
...
class BrownianMotionOnSphere(SOnPathDistribution):
    """Our uninformative prior on the sphere."""
    def __init__(
        self,
        dim,
        sigma: Tensor,
